...
public class DnaDecrypterScreen extends AbstractGeneticsScreen<DnaDecrypterScreenHandler> {
    ...
    private static final Identifier TEXTURE = new Identifier(AdvancedGenetics.MOD_ID, "textures/gui/dna_decrypter_gui.png");

    protected final List<DisplayData> displayData = new ArrayList<>();

    public DnaDecrypterScreen(DnaDecrypterScreenHandler handler, PlayerInventory inventory, Text title) {
